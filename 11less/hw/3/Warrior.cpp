...
// Warrior*  KnightFactory::create(int&& _hp, int&& _damage) const {
//         return new Knight(_hp, _damage);
//     }
...
// Warrior*  MageFactory::create(int&& _hp, int&& _damage) const {
//         return new Mage(_hp, _damage);
//     }
...
// Warrior*  ArcherFactory::create(int&& _hp, int&& _damage) const {
//     return new Archer(_hp, _damage);
// }
